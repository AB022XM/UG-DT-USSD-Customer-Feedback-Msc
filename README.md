...
To build the final jar and optimize the USSDCustomerFeedbackMsc application for production, run:
...
Then navigate to [http://localhost:9023](http://localhost:9023) in your browser.
...
[Service Discovery and Configuration with the JHipster-Registry]: https://www.jhipster.tech/documentation-archive/v8.0.0-beta.3/microservices-architecture/#jhipster-registry
